...
Agenda is a simple application to manage everyday activities. It is being developed by [Grenda Silva](https://github.com/GrendaCarla) and [Quézia Godoy](https://github.com/Leckaa) with Dart language during the class of development for mobile systems of the graduation of ADS in the [University São Fancisco](https://www.usf.edu.br/).
